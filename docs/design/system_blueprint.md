...
このドキュメントでは、汎用単語・用語学習アプリ `vocab-spring` の全体像を、エンジニアの視点と初学者のわかりやすさを両立して解説します。

---

## 1. システム概要
`vocab-spring` は、英単語に限らず、専門用語、IT用語、資格試験の対策など、あらゆる「暗記と理解」をサポートする自分専用のデジタル単語帳アプリです。
AI（Gemini）による学習フィードバックや、詳細な学習統計機能を備え、効率的な知識の定着を支援します。
